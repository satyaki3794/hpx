...
#if !defined(INTERIM_THREAD_POOL)
#define INTERIM_THREAD_POOL
...
namespace hpx { namespace threads { namespace detail
{
    ...
    class HPX_EXPORT interim_thread_pool
    {
    public:
        interim_thread_pool(std::shared_ptr<threads::policies::scheduler_base> sched,
    ...
    private:
        ...
        std::shared_ptr<threads::policies::scheduler_base> sched_;
