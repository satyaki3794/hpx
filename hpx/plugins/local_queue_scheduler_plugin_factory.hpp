...
#define HPX_REGISTER_LQ_SCHEDULER_PLUGIN_FACTORY(SchedulerPlugin, pluginname)                                            \
    HPX_REGISTER_SCHEDULER_PLUGIN_FACTORY_BASE(                                                                       \
        hpx::plugins::local_queue_scheduler_plugin_factory<SchedulerPlugin>, pluginname)           \
    HPX_DEF_UNIQUE_PLUGIN_NAME(                                                                                       \
        hpx::plugins::local_queue_scheduler_plugin_factory<SchedulerPlugin>, pluginname)           \
    template struct hpx::plugins::local_queue_scheduler_plugin_factory<SchedulerPlugin>;           \
