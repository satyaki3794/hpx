...
namespace hpx { namespace threads
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    interim_threadmanager_impl::interim_threadmanager_impl(
      ...
      : num_threads_(num_threads),
        ...
        thread_logger_("interim_threadmanager_impl::register_thread"),
        work_logger_("interim_threadmanager_impl::register_work"),
        set_state_logger_("interim_threadmanager_impl::set_state"),
    ...
    std::size_t interim_threadmanager_impl::init(
    ...
    ///////////////////////////////////////////////////////////////////////////
    boost::int64_t interim_threadmanager_impl::
    ...
    void interim_threadmanager_impl::
    ...
    // here.
    bool interim_threadmanager_impl::
    ...
    ///////////////////////////////////////////////////////////////////////////
    void interim_threadmanager_impl::register_work(
    ...
    naming::gid_type interim_threadmanager_impl::
            ...
            performance_counters::counter_info const& info, error_code& ec)
    {
        ...
        typedef detail::interim_thread_pool spt;
    ...
    bool interim_locality_allocator_counter_discoverer(
            ...
            performance_counters::counter_info const& info, error_code& ec)
    {
        ...
        typedef interim_threadmanager_impl ti;
        ...
        if (paths.instancename_ == "total" && paths.instanceindex_ == -1)
        {
            // overall counter
            using performance_counters::detail::create_raw_counter;
            boost::int64_t (interim_threadmanager_impl::*avg_idle_rate_ptr)(
                bool
            ) = &ti::avg_idle_rate;
    ...
    ///////////////////////////////////////////////////////////////////////////
    naming::gid_type
    interim_counter_creator(performance_counters::counter_info const& info,
    ...
    defined(HPX_HAVE_THREAD_CREATION_AND_CLEANUP_RATES)
        ...
        for (creator_data const* d = data; d < &d[data_size]; ++d)
        {
            ...
            {
                return interim_counter_creator(info, paths, d->total_func,
        ...
        register_counter_types()
    {
        ...
        performance_counters::generic_counter_type_data counter_types[] =
        {
            ...
            { "/threads/count/objects", performance_counters::counter_raw,
              ...
              counts_creator,
              &interim_locality_allocator_counter_discoverer,
              ""
            },
#ifdef HPX_HAVE_THREAD_STEALING_COUNTS
